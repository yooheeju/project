	...
	<div class="w3-content" style="max-width: 1100px; margin-top: 80px; margin-bottom: 80px">
		...
		<div style="text-align: center; ">
			...
			<tr>
				...
				<td>${requestScope.dto.jobsDto.min_salary}</td>
				<td>${requestScope.dto.jobsDto.max_salary}</td>
				<td>${requestScope.dto.center_id}</td>
				<td>${requestScope.dto.centerDto.center_name}</td>
				<td>${requestScope.dto.centerDto.street_address}</td>
				<td>${requestScope.dto.centerDto.si_id}</td>
			</tr>
		</table>
	</div>
