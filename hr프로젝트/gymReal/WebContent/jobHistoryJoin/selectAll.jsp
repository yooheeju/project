...
<!-- Links (sit on top) -->
	...
	<div style="text-align: center; max-width: 1000px; margin: 0 auto;">
      ...
      <c:forEach items="${dtos}" var="jobHistoryJoin">
			<tr>
				<td>
    				<a href='/gymReal/jobHistoryJoin/selectOne.jobHistoryJoin?job_history_id=${jobHistoryJoin.job_history_id}'>
        			${jobHistoryJoin.job_history_id}
    				</a>
				</td>
				<td>${jobHistoryJoin.job_id}</td>
				<td>${jobHistoryJoin.jobsDto.job_title}</td>
				<td>${jobHistoryJoin.employee_id}</td>
				<td>${jobHistoryJoin.employeesDto.name}</td>
				<td>${jobHistoryJoin.category_id}</td>
				<td>${jobHistoryJoin.categoryDto.category_name}</td>
				<td>${jobHistoryJoin.employeesDto.commission_pct}</td>
