...
public class EmpCenJobDto {
	...
	public EmpCenJobDto() {}
	public EmpCenJobDto(Integer employee_id, String name, String email, String phone, Integer salary,
			Integer commission_pct, Integer job_id, Integer center_id, CenterDto centerDto, JobsDto jobsDto) {
		super();
	...
	public String toString() {
		return "EmpCenJobDto [employee_id=" + employee_id + ", name=" + name + ", email=" + email + ", phone=" + phone
				+ ", salary=" + salary + ", commission_pct=" + commission_pct + ", job_id=" + job_id + ", center_id="
				+ center_id + ", centerDto=" + centerDto + ", jobsDto=" + jobsDto + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((centerDto == null) ? 0 : centerDto.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmpCenJobDto other = (EmpCenJobDto) obj;
		if (centerDto == null) {
			if (other.centerDto != null)
				return false;
		} else if (!centerDto.equals(other.centerDto))
			return false;
		if (center_id == null) {
