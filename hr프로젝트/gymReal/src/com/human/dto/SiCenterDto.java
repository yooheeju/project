...
public class SiCenterDto {
	...
	public SiCenterDto() {}
	public SiCenterDto(Integer center_id, String street_address, String center_name, Integer si_id, SiDto siDto) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SiCenterDto other = (SiCenterDto) obj;
		if (center_id == null) {
	...
	public String toString() {
		return "SiCenterDto [center_id=" + center_id + ", street_address=" + street_address + ", center_name="
				+ center_name + ", si_id=" + si_id + ", siDto=" + siDto + "]";
	}
