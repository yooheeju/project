...
import com.human.service.DoSiService;


@WebServlet("*.doSi")
public class DoSiController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public DoSiController() {
        super();
    }
...
//		} else 
		if (command.equals("/doSi/selectAll.doSi")) {
			viewPage = "selectAll.jsp";
			DoSiService.selectAll(request, response);
			System.out.println("/doSi/selectAll.doSi");
		}
