...
<script>
	...
	$(document).ready(function() {
		...
		$("#replies").on("click", ".rereplyAddBtn", function() {
			...
			console.log("bId는", bId);
			console.log("rId는", rId);
			console.log("rGroup는", rGroup);
			console.log("replyer는", replyer);
			console.log("replytext는", replytext);
					...
					$(data.list).each(
							...
							str+="<li>"
								...
								str += this.replyer+ " <br> "
									...
									+ "<div>"
									+ "<textarea id='replytext' placeholder='수정 할 내용'style='width: 500px; height: 120px;'></textarea>"
									+ "</div>"
									+ "<div>"
...
<div class="row">
	...
	<div class="main" style="border: 1px solid #ddd; border-radius: 10px; ">
		...
		<div>
			<img src="/ex/resources/img/person_icon.png" width=40px>${boardDto.bName}<br>
			<fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${boardDto.bWriteTime}" />
		</div>
		<hr>
